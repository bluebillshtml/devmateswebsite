        ...
        <nav className="nav-container">
          <div className="nav-content">
            <div className="nav-left">
              ...
              <img className="logo" src="/logo.png" alt="Scout Logo" width="110" height="20" />
            </div>
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          <div className="beta-badge">
            <svg width="62" height="11" viewBox="0 0 62 12" fill="none">
        ...
        <div className="logo-cloud-grid">
          ...
          <div className="logo-item">
            <svg width="140" height="30" viewBox="0 0 140 30" fill="none">
              ...
              <path d="M41.895 5.01562V12.6357H41.9873C42.2597 12.2314 42.541 11.8667 42.831 11.5415C43.121 11.2163 43.4418 10.9395 43.7934 10.7109C44.1538 10.4736 44.5493 10.2935 44.9799 10.1704C45.4106 10.0474 45.8984 9.98584 46.4433 9.98584C47.4892 9.98584 48.3286 10.1968 48.9614 10.6187C49.603 11.0317 50.0776 11.6646 50.3852 12.5171C50.5522 12.9741 50.6708 13.4883 50.7412 14.0596C50.8203 14.6309 50.8598 15.2725 50.8598 15.9844V24H47.2475V14.9429C47.2475 14.231 47.0805 13.6685 46.7465 13.2554C46.4125 12.8335 45.9335 12.6226 45.3095 12.6226C44.958 12.6226 44.6152 12.7104 44.2812 12.8862C43.9472 13.062 43.6308 13.2817 43.332 13.5454C43.0331 13.8091 42.7607 14.0991 42.5146 14.4155C42.2685 14.7319 42.062 15.0352 41.895 15.3252V24H38.2695V5.01562H41.895Z" fill="#4B4B4C"/>
            </svg>
          </div>
          <div className="logo-item">
            <svg width="115" height="30" viewBox="0 0 115 30" fill="none">
              <path fillRule="evenodd" clipRule="evenodd" d="M32.8561 13.5585C33.2434 14.2291 33.2434 15.0554 32.8561 15.7261L25.6534 28.2008C25.2661 28.8714 24.5505 29.2846 23.776 29.2846H9.37056C8.59609 29.2846 7.88044 28.8714 7.49313 28.2008L0.290482 15.7261C-0.0968273 15.0554 -0.0968273 14.2291 0.290482 13.5585L7.49313 1.08381C7.88044 0.413149 8.59609 0 9.37056 0H23.776C24.5505 0 25.2661 0.413149 25.6534 1.08381L32.8561 13.5585Z" fill="white"/>
              <path d="M40 23.0546V6H48.3391C50.3072 6 51.994 6.31629 53.3897 6.94385C54.7905 7.57142 55.8598 8.52029 56.6029 9.78546C57.346 11.0506 57.7225 12.627 57.7225 14.5147C57.7225 16.4024 57.351 17.9789 56.6029 19.2441C55.8548 20.5093 54.7855 21.4631 53.3897 22.1007C51.989 22.7384 50.3072 23.0546 48.3391 23.0546H40Z" fill="white"/>
            </svg>
          </div>
        </div>
      </section>
      ...
      <section className="testimonials-section">
        ...
        <div className="testimonial-content">
          <blockquote className="testimonial-quote">
            <p>"Scout is an indispensable tool for</p>
            <p>our Engineering, DS and Sales teams</p>
            <p>to engage with our customers.  We</p>
            <p>rely on Scout daily, making it an</p>
            <p>integral part of our operations."</p>
          </blockquote>
          <div className="testimonial-author">
            <img src="https://api.builder.io/api/v1/image/assets/TEMP/4701b1dc02b005e2d30beb78561bdc5f84905a0e?width=80" alt="Vijaye Raji" className="author-avatar" />
            <div className="author-info">
              <div className="author-name">Vijaye Raji</div>
              <div className="author-title">CEO of Statsig</div>
            </div>
          </div>
        </div>
